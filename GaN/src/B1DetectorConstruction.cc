...
{  
  ...
  // define Elements
  G4Element* elGa = new G4Element("Gallium" , "Ga", 31., 11.81*g/mole);
  G4Element* elN  = new G4Element("Nitrogen", "N" , 7. , 34.98*g/mole);

  // define simple materials
  // define a material from elements.   case: chemical molecule
  G4Material* detector_mat = new G4Material("Gallium nitride", 6.1*g/cm3, 2);
  detector_mat->AddElement(elGa, 1);
  detector_mat->AddElement(elN , 1);
